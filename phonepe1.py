...
Aggre_insurance.drop_duplicates(inplace=True)
...
Aggre_transaction = pd.DataFrame(table2, columns = ("States", "Years", "Quarter", "Transaction_type",
                                                  "Transaction_count", "Transaction_amount"))
Aggre_transaction.drop_duplicates(inplace=True)
...
Aggre_user.drop_duplicates(inplace=True)
...
Map_insurance = pd.DataFrame(table4, columns = ("States", "Years", "Quarter", "District",
                                                  "Transaction_count", "Transaction_amount"))
Map_insurance.drop_duplicates(inplace=True)
...
Map_transaction = pd.DataFrame(table5, columns = ("States", "Years", "Quarter", "District",
                                                  "Transaction_count", "Transaction_amount"))
Map_transaction.drop_duplicates(inplace=True)
...
Map_user.drop_duplicates(inplace=True)
...
Top_insurance = pd.DataFrame(table7, columns = ("States", "Years", "Quarter", "Pincodes",
                                                  "Transaction_count", "Transaction_amount"))
Top_insurance.drop_duplicates(inplace=True)
...
Top_transation = pd.DataFrame(table8, columns = ("States", "Years", "Quarter", "Pincodes",
                                                  "Transaction_count", "Transaction_amount"))
Top_transation.drop_duplicates(inplace=True)
...
Top_user = pd.DataFrame(table9, columns = ("States", "Years", "Quarter", "Pincodes",
                                                  "RgisteredUsers"))
Top_user.drop_duplicates(inplace=True)
...
if select == "Home":
    ...
    col2 = st.write("****Easy Transactions****")
...
if select == "Data Exploration":
    ...
    with tab3:
        ...
        if method_top == "Top Insurance Analysis":
            ...
            col1,col2= st.columns(2)
            with col1:
                years_t2= st.slider("**Select the Year_tt**", Top_transation["Years"].min(), Top_transation["Years"].max(),Top_transation["Years"].min())

            df_top_tran_Y= Aggre_insurance_Y(Top_transation,years_t2)
